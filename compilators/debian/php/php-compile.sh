...
#sudo ./configure --prefix=/usr/local/che/php \
#        --enable-fpm \
#        --with-fpm-user=admin \
...
PACKAGE_MAIN_DIR=$MAIN_DIR/che-php-8.2.0-$1
...
sudo mv /usr/local/che/php $PACKAGE_MAIN_DIR/usr/local/che
sudo cp $MAIN_DIR/php-fpm.conf $PACKAGE_MAIN_DIR/usr/local/che/php/etc
sudo mv $PACKAGE_MAIN_DIR/usr/local/che/php/sbin/php-fpm $PACKAGE_MAIN_DIR/usr/local/che/php/sbin/che-php-fpm

# Add php.ini file
sudo cp $MAIN_DIR/php.ini $PACKAGE_MAIN_DIR/usr/local/che/php/lib/php.ini
...
sudo dpkg --info $MAIN_DIR/che-php-8.2.0-$1.deb
sudo dpkg --contents $MAIN_DIR/che-php-8.2.0-$1.deb

# Move debian package to dist folder
sudo mkdir -p $MAIN_DIR/dist
sudo mv $MAIN_DIR/che-php-8.2.0-$1.deb $MAIN_DIR/dist
